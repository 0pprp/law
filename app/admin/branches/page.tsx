...
import { APPROVED_BRANCH_NAMES, filterSelectableBranches, isMainBranchName } from '@/lib/branch-constants'
...
export default function BranchesPage() {
  ...
  useEffect(() => {
    const supabase = createClient()
    supabase.from('branches').select('*').eq('is_active', true).in('name', [...APPROVED_BRANCH_NAMES]).order('name')
