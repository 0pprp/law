  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        subtitle="أسماء مرحلة المرافعات — تأشير تم التجهيز يكتب ملاحظة للمدين ويُميّز صفّه بالأخضر في المراحل اللاحقة"
      ...
      >
        <div className="px-4 sm:px-5 py-3 border-b border-emerald-100 bg-emerald-50/80">
          ...
          <p className="text-xs text-[#767676] mt-0.5">
            يظهر الاسم هنا بعد اعتماد إقامة دعوى وتحويله إلى مرافعات، ويغادر الكارد بعد إنجاز المرافعات والانتقال لمهمة أخرى
          </p>
        </div>
