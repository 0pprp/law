...
export default function TaskAcceptanceActions({ taskId, taskLabel, expiresAt }: Props) {
    ...
    <div className="bg-amber-50 border-2 border-amber-300 rounded-2xl p-4 space-y-3 shadow-sm">
      <div>
        ...
        <p className="text-xs text-amber-800 mt-1 leading-relaxed">
          {taskLabel
            ? <>تم تكليفك بمهمة «<span className="font-bold">{taskLabel}</span>». </>
            : 'تم تكليفك بهذه المهمة. '}
          يجب قبولها أو رفضها قبل{' '}
