...
export const ACTIVITY_ACTION_LABELS: Record<string, string> = {
  ...
  bulk_unassign_tasks: 'إلغاء تكليف مهام',
  ...
  create_special_status: 'إضافة للأسماء التي تحتاج مراقبة',
  update_special_status: 'تعديل الأسماء التي تحتاج مراقبة',
  ...
  import_criminal_debtors_start: 'بدء استيراد جزائي',
  import_criminal_debtors: 'استيراد مدينين جزائيين',
  upload_criminal_documents: 'رفع مستمسكات جزائي',
  upload_criminal_petition: 'رفع عريضة جزائي',
  ...
  create_debtor_petition: 'إنشاء عريضة الدعوى',
  ...
  lawyer_stationery_deposit: 'إيداع محفظة القرطاسية',
  lawyer_stationery_withdraw: 'سحب محفظة القرطاسية',
  lawyer_fee_deposit: 'إيداع محفظة أتعاب محامي',
...
export const ACTIVITY_ACTION_BADGE: Record<string, 'success' | 'info' | 'warning' | 'danger' | 'orange' | 'navy'> = {
  ...
  import_criminal_debtors_start: 'info',
  import_criminal_debtors: 'success',
  upload_criminal_documents: 'success',
  upload_criminal_petition: 'success',
  ...
  lawyer_stationery_deposit: 'success',
  lawyer_stationery_withdraw: 'warning',
  lawyer_fee_deposit: 'success',
  assign_task: 'info',
  bulk_assign_tasks: 'info',
  bulk_unassign_tasks: 'warning',
  create_task: 'info',
  submit_task: 'info',
  update_task: 'warning',
