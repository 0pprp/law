...
export const ACTIVITY_ACTION_LABELS: Record<string, string> = {
  ...
  create_special_status: 'إضافة حالة خاصة',
  update_special_status: 'تعديل حالة خاصة',
  delete_special_status: 'حذف حالة خاصة',
  set_debtor_special_status: 'تعيين حالة خاصة لمدين',
