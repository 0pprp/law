...
ok('3 الحقول الثمانية فقط', PETITION_FIELD_KEYS_COUNT(petitionLib) === 8)
...
ok('طبيعة عمل المدعى عليه', petitionLib.includes('defendantOccupation') && petitionLib.includes('طبيعة عمل المدعى عليه'))
ok('صيغة / يسكن بعد طبيعة العمل', petitionLib.includes('/ يسكن') && !petitionLib.includes('|يسكن'))
...
ok('20 Activity Log', apiSrc.includes('create_debtor_petition') && apiSrc.includes('PETITION_ATTACHMENT_LABEL') && apiSrc.includes('مرفقات المدين'))
