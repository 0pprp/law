-- إيداع/سحب يدوي لمحفظة مدير القانونية
-- يدعم enum wallet_transaction_type + قيد CHECK lawyer_wallet_transactions_type_check
...
-- بعض القواعد تستخدم text + CHECK بدل enum — تحديث القيد
DO $$
BEGIN
  IF EXISTS (
