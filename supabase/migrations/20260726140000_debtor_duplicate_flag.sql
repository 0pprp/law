-- كارد «الأسماء المكررة» — تحويل من تحت إسناد مهمة
--
-- للتراجع (Down):
--   DROP INDEX IF EXISTS idx_debtors_duplicate_flagged;
--   ALTER TABLE debtors DROP COLUMN IF EXISTS duplicate_flagged_by;
--   ALTER TABLE debtors DROP COLUMN IF EXISTS duplicate_flagged_at;
