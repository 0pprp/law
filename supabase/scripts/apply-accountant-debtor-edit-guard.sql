-- تشغيل يدوي من Supabase SQL Editor.
-- المحاسب يعدّل حقول نموذج المدين فقط، وتبقى حالة القضية/المهام/الأرصدة/الفرع محمية.
...
BEGIN
  ...
  v_old_protected := to_jsonb(OLD) - ARRAY[
    ...
    'receipt_type', 'receipt_number', 'receipt_amount',
    'lawyer_fees', 'penalty_amount', 'has_contract',
    'receipt_signed_legal_costs', 'notes', 'branch_list_id', 'updated_at'
  ];
