-- تطبيق يدوي: RLS لمسؤول متابعة التسديد (كل الفروع)
-- لا يعتمد بفرع واحد — يرى كل مديني جاري التسديد في كل المحافظات.
-- شغّل بعد apply-payment-follow-up-role.sql
...
AS $$
  -- الدور يرى كل الفروع؛ الشرط الوحيد: حالة جاري التسديد
