-- تطبيق يدوي: طلبات عدم الالتزام (جاري التسديد)
-- انسخ المحتوى بالكامل إلى Supabase SQL Editor وشغّله مرة واحدة.
-- المصدر: supabase/migrations/20260719010000_payment_noncompliance_requests.sql
-- يتضمن أيضاً إصلاح رؤية مسؤول متابعة التسديد لكل الفروع.

-- ——— إصلاح: الدور يرى كل مديني جاري التسديد (كل المحافظات) ———
