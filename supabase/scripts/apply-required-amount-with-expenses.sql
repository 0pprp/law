-- تشغيل يدوي آمن من Supabase SQL Editor.
-- المبلغ المطلوب =
-- MIN(قاعدة الوصل + إجمالي المصروفات + الشرط الجزائي، مبلغ الوصل الأصلي)
-- القاعدة = المطلوب − المصروفات − الشرط (وليست المتبقي الحي بعد التسديدات)
